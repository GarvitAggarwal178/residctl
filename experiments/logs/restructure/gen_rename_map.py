#!/usr/bin/env python3
"""Generate experiments/logs/restructure/rename-map.csv for the repository restructure.
...
with open("experiments/logs/restructure/rename-map.csv", "w", newline="") as f:
    w = csv.writer(f)
