...
Analysis only — no new sweeps in WP3 itself. Everything here is generated
by `make_wp3.py` from CSVs on disk. Each figure has a PNG at 200 dpi **and**
a CSV of the numbers behind it, in `results/overnight/figures/`.
